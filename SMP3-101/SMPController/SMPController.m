...
- (NSError *)initialiseSMP{
    ...
    self.smpSecProvider = @"Generic_USER_PASS_auth";
    self.smpServer = @"smp3server";
    self.smpPort = @"8080";
    
    // Setup odata service info
    self.odataURL = @"http://services.odata.org/Northwind/Northwind.svc/";
    self.entityName = @"Customers";
